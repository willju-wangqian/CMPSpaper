...
\texttt{R} package \CRANpkg{cmpsR} on CRAN.
...
implemented as \texttt{R} Shiny App \citep{shiny}, \pkg{bulletinspectR}
...
\pkg{bulletxtrctr} \citep{bulletxtrctr}. Similar to the CMPS algorithm,
...
\item
  ...
  package versions of \pkg{bulletxtrctr} and \texttt{cmpsR} meet the
  requirements.
\item
