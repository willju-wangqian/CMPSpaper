...
According to the Uniform Crime Reporting Program of FBI (Federal Bureau of Investigation), "More than 73 percent (73.7) of the homicides for which the FBI received weapons data in 2019 involved the use of firearms" [@fbiucr], and firearm examination could play an important role in all these cases. \hh{XXX the new data for 2020 came out on Sep 27 - homicides are up by close to 30%. We might want to mention that.}
