...
In order to obtain bullet signatures from the x3p files of bullet land engravings, we use the `R` packages \pkg{x3ptools} [@x3ptools] and \pkg{bulletxtrctr} [@bulletxtrctr].
