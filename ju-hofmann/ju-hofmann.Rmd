...
\wj{change}
Our implementation is made available as part of the `R` package \pkg{cmpsR} on CRAN.
...
\wj{can be found in the supplementary materials of this paper? }
...
\wj{in the supplementary materials?}
