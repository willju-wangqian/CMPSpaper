...
candidate positions across different segments are compared using a small tolerance \hh{XXX parameter for this} and basis segments with a congruent registration position are determined. These segments are called the "congruent matching profile segments" (CMPS), and the number of CMPS is the CMPS score of the comparison.
