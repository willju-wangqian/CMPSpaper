...
The signatures of Land 4 of Bullet 1 and Land 5 of Bullet 2 are stored in objects sigs2 and sigs1, respectively. This comparison is \hh{one of a pair of signatures that are known to be a match -- a KM (known match) comparison}. We compute the CMPS score using two versions of the CMPS algorithm:
