...
The automated framework for extracting signatures from x3p files used in this paper was proposed by @aoas and is implemented in the `R` packages `x3ptools` [@x3ptools] and `bulletxtrctr` [@bulletxtrctr].
