...
```
-->
```{r sigplot, echo=TRUE,  out.width="300px", fig.cap=" \\hh{I don't think we need fig 3 when we have fig 4 XXX} The dark grey line shows the comparison signature; each red line segment shows one comgruent matching profile segment. "}
