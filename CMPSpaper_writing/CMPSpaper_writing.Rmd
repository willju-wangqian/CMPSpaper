...
\autoref{fig:segplots}  shows the top five registration positions for segment number 6 overlaid on top of the reference signature using hashed lines, the solid line in black shows the original position of the segment (which in this instance is close to the actual registration position). 
Then at each segment scale, we will have two plots, `segment_plot` and `scale_ccf_plot`. 
