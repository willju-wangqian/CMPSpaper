...
The CMPS algorithm consists of \hh{three main} steps:
...
It takes a profile {XXX profile or signature?} in the format of a numeric vector and cuts it into consecutive, non-overlapping and equal-length segments of length `len`.
