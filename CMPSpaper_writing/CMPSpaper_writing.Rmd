...
```{r tiles, echo=FALSE, fig.cap="Overview of all 36 CMPS scores resulting from a bullet-to-bullet comparison of all six lands on each bullet.", out.width=".7\\textwidth", fig.align="center"}
