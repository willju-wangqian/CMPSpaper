...
Introduce the CMPS method/algorithm
...
* (?) apply it to Hamby44, using Hamby252 (default) parameters
* apply it to Hamby44, using parameters such that `lengths` represents the same actual length (the same amount of pixels of the scan)
